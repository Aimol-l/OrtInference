...
std::variant<bool,std::string> SAM2::initialize(std::vector<std::string>& onnx_paths, bool is_cuda){
 ...
 try {
    ...
    //************************************************************
    this->load_onnx_info(this->img_encoder_session,this->img_encoder_input_nodes,this->img_encoder_output_nodes,"img_encoder");
    this->load_onnx_info(this->mem_attention_session,this->mem_attention_input_nodes,this->mem_attention_output_nodes,"mem_attention");
    this->load_onnx_info(this->img_decoder_session,this->img_decoder_input_nodes,this->img_decoder_output_nodes,"img_decoder");
    this->load_onnx_info(this->mem_encoder_session,this->mem_encoder_input_nodes,this->mem_encoder_output_nodes,"mem_encoder");
...
std::variant<std::vector<Ort::Value>,std::string> SAM2::mem_attention_infer(std::vector<Ort::Value>&img_encoder_out){
    ...
    input_tensor.push_back(std::move(memory_2));
    ...
    input_tensor.push_back(std::move(memory_pos_1));
    input_tensor.push_back(std::move(memory_pos_2));
    //*******************************************************************************
    try {
